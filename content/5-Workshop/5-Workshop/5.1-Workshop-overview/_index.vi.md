...
> Bạn hãy vẽ sơ đồ kiến trúc hệ thống DocuMind AI gồm các thành phần: React Frontend, Node.js/Express Backend API, Amazon S3, Amazon SQS, Worker xử lý tài liệu, Amazon Textract, AI Gateway, Google Gemini API, OpenAI ChatGPT API, Amazon RDS PostgreSQL, AWS Secrets Manager, Amazon CloudWatch, IAM Role và AWS WAF. Lưu ảnh tại đường dẫn `/images/5-Workshop/5.1-Workshop-overview/architecture.png`.
